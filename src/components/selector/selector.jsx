...
const icons = {
    'All Cases': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            ...
            <path
                ...
                fill="none" stroke="#000" />
            <path d="M15,13.55a1.44,1.44,0,1,1-1.44-1.44" fill="none" stroke="#000" />
            <path d="M19,11.06a1.43,1.43,0,1,1-1.43-1.43" fill="none" stroke="#000" />
            <path d="M12.78,9.2a1.44,1.44,0,1,1-1.43-1.44" fill="none" stroke="#000" />
            <path d="M17.52,17.86a1.44,1.44,0,1,1-1.43-1.43" fill="none" stroke="#000" />
            <path d="M11,16.3a1.44,1.44,0,1,1-1.43-1.44" fill="none" stroke="#000" />
        </svg>
    ),
    'Wildlife': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            <path d="M19,5.86a2.85,2.85,0,0,1-1.37.22,2.8,2.8,0,1,1,3-2.53" fill="none"
                stroke="#000" />
            <path d="M15.79,20a5.51,5.51,0,0,0,1.9-4.16" fill="none" stroke="#000" />
            <path d="M7.9,10.29a6.48,6.48,0,0,0-1.06.9,6.28,6.28,0,0,0,4.57,10.59" fill="none"
                stroke="#000" />
            <line x1="15.89" y1="5.71" x2="7.9" y2="10.29" fill="none" stroke="#000" />
            <path
            ...
            <path d="M6.93,20H2.59A2.1,2.1,0,0,0,.5,22.07h0a2.1,2.1,0,0,0,2.09,2.1H13.9" fill="none"
                stroke="#000" />
            <path d="M11.41,21.78h7.14a1.71,1.71,0,0,0-1.72-1.71H14.09" fill="none" stroke="#000" />
        </svg>
    ),
    'Dairy Farms': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            ...
            <rect x="4.97" y="7.98" width="5.06" height="3.07" rx="0.88"
                transform="translate(15.01 19.03) rotate(-180)" fill="none" stroke="#000" />
            <path
    ...
    'Wild Birds': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            ...
            <path d="M22.17,17.7a9.59,9.59,0,0,1-3,.47,9.46,9.46,0,0,1-9-12.28" fill="none"
                stroke="#000" />
            <line x1="12.26" y1="18.92" x2="12.26" y2="25.52" fill="none" stroke="#000" />
            <line y1="4.05" x2="3.03" y2="4.05" fill="none" stroke="#000" />s
        </svg>
    ),
    'Poultry Farms': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            <path d="M2.9,12.55V3.37h0A8.62,8.62,0,0,1,11.67,12v.18a.4.4,0,0,0,.4.41h3.45"
                fill="none" stroke="#000" />
            <path d="M20.45,12.59a8.78,8.78,0,1,1-17.55,0" fill="none" stroke="#000" />
            <path d="M17.21,12.59A7.16,7.16,0,1,1,2.9,12.5" fill="none" stroke="#000" />
            <path d="M17.21,12.59a8.9,8.9,0,0,1,8.94-8.87" fill="none" stroke="#000" />
            <path d="M20.45,12.59A5.54,5.54,0,0,1,26,7.08" fill="none" stroke="#000" />
            <polyline points="9.98 21.13 9.98 25.94 8.16 25.94" fill="none" stroke="#000" />
            <polyline points="13.17 21.13 13.17 25.94 11.36 25.94" fill="none" stroke="#000" />
            <path d="M2.39,4.45A1.89,1.89,0,0,0,.5,6.34h2" fill="none" stroke="#000" />
    ...
    'Human': (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            <circle cx="10.95" cy="7.08" r="6.58" fill="none" stroke="#000" />
            <path d="M.5,26a10.45,10.45,0,1,1,20.89,0" fill="none" stroke="#000" />
        </svg>
    )
};
...
export default function Selector(props) {
    ...
    return (
        <div className={styles.selector + ' borderBox'}>
            <ul>
