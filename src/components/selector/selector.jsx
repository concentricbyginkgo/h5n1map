...
const icons = {
    'All Cases': (
        <div className={styles.iconContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27.18 27.18">
    ...
    'Dairy Farms': (
        <div className={styles.iconContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.9 24.66" className={styles.dairyTransform}>
                <path
    ...
    'Poultry Farms': (
        <div className={styles.iconContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.15 26.44" className={styles.poultryTransform}>
    ...
    'Human': (
        <div className={styles.iconContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.89 25.97" className={styles.humanTransform}>
    ...
    'Wildlife': (
        <div className={styles.iconContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.4 24.67">
